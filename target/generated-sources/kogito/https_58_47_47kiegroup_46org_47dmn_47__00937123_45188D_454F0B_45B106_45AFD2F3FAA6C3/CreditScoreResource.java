 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__00937123_45188D_454F0B_45B106_45AFD2F3FAA6C3;
...
public class CreditScoreResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_00937123-188D-4F0B-B106-AFD2F3FAA6C3", "CreditScore");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_00937123-188D-4F0B-B106-AFD2F3FAA6C3", "CreditScore", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("CreditScore") + ".dmn_nologic")));
    }
